...
urlpatterns = [
    ...
    path('api/wallet/<str:token>/<str:user_id>/<str:amount>/', views.WalletUserBalance.as_view()),
    ...
    path(
        'initiate_mtn_transaction/<str:token>/<str:user_id>/<str:txn_type>/<str:txn_status>/<str:paid_at>/<str:channel>/<str:ishare_balance>/<str:color_code>/<str:data_volume>/<str:reference>/<str:data_break_down>/<str:amount>/<str:receiver>/<str:date>/<str:image>/<str:time>/<str:date_and_time>/',
